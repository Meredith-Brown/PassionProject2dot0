...
import mer.zipcode.passionproject2.repository.LocationRepository;
...
class LocationResourceIT {
    ...
    void createLocation() throws Exception {
        ...
        assertThat(testLocation.getVisited()).isEqualTo(DEFAULT_VISITED);
    }
    ...
    @Test
    @Transactional
    void checkVisitedIsRequired() throws Exception {
        int databaseSizeBeforeTest = locationRepository.findAll().size();
        // set the field null
    ...
    void putNewLocation() throws Exception {
        ...
        assertThat(testLocation.getVisited()).isEqualTo(UPDATED_VISITED);
    }
    ...
    void partialUpdateLocationWithPatch() throws Exception {
        ...
        partialUpdatedLocation.name(UPDATED_NAME).postalCode(UPDATED_POSTAL_CODE).city(UPDATED_CITY).country(UPDATED_COUNTRY);
