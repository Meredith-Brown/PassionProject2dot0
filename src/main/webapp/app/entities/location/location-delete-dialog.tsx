...
export const LocationDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="passionProject2App.location.delete.question">
        <Translate contentKey="passionProject2App.location.delete.question" interpolate={{ id: locationEntity.id }}>
