package mer.zipcode.passionproject2.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, mer.zipcode.passionproject2.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, mer.zipcode.passionproject2.repository.UserRepository.USERS_BY_EMAIL_CACHE);
