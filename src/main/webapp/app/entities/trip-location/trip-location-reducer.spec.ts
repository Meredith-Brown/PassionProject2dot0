...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRIPLOCATION_LIST actions', async () => {
    ...
    it('dispatches FETCH_TRIPLOCATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TRIPLOCATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TRIPLOCATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TRIPLOCATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TRIPLOCATION actions', async () => {
      const expectedActions = [
        {
